...
function ColorPicker:Constructor(color, dimension)
    ...
    if (color) then
        color = TeamOrganizer.Utils.Color(color.R, color.G, color.B);
    else
    ...
    self.color = TeamOrganizer.Utils.Color(1, 0.5, 0.5, 0.5);
    self.originalColor = TeamOrganizer.Utils.Color(color.R, color.G, color.B);
    ...
    self.radioButtons["R"] = TeamOrganizer.UI.RadioButton(self.radioContainer, L:GetText("Red"), true);
    ...
    self.radioButtons["G"] = TeamOrganizer.UI.RadioButton(self.radioContainer, L:GetText("Green"), false);
    ...
    self.radioButtons["B"] = TeamOrganizer.UI.RadioButton(self.radioContainer, L:GetText("Blue"), false);
    ...
    self.radioButtons["H"] = TeamOrganizer.UI.RadioButton(self.radioContainer, L:GetText("Hue"), false);
    ...
    self.radioButtons["S"] = TeamOrganizer.UI.RadioButton(self.radioContainer, L:GetText("Saturation"), false);
    ...
    self.radioButtons["V"] = TeamOrganizer.UI.RadioButton(self.radioContainer, L:GetText("Value"), false);
    ...
    TeamOrganizer.UI.RadioButton.LinkPeers({self.radioButtons["R"], self.radioButtons["G"], self.radioButtons["B"], self.radioButtons["H"], self.radioButtons["S"], self.radioButtons["V"]});
    ...
    for colorName, color in pairs(Turbine.UI.Color) do
        if (Turbine.UI.Color:IsA(color) and (color.A == 1)) then
            color = TeamOrganizer.Utils.Color(color.A, color.R, color.G, color.B);
...
function ColorPicker:HexChanged()
    ...
    if (R and G and B) then
        ...
        self.hex:SetBackColor(TeamOrganizer.Utils.Color(1, 1, 0, 0));
    end
end
