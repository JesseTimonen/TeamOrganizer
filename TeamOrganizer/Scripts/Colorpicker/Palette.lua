...
function Palette:Constructor(parent, dimensionX, dimensionY, color)
    ...
    self.overlay:SetBackground("TeamOrganizer/Images/ColorPicker/V_x_H.tga");
...
function Palette:SetGamut(color)
    ...
    elseif (sliderDimension == "S") then
        local backColor = TeamOrganizer.Utils.Color(1 - sliderValue, 1, 1, 1);
        self.overlay:SetBackColor(backColor);
    elseif (sliderDimension == "H") then
        ...
        local backColor = TeamOrganizer.Utils.Color(1 - sliderValue, 0, 0, 0);
        self.overlay:SetBackColor(backColor);
    end
end
...
function Palette:SetDimensions(dimensionX, dimensionY)
    ...
    elseif (sliderDimension == "H") then
        self:SetBackground("TeamOrganizer/Images/ColorPicker/S_x_V_back.tga");
